public class UrbanBikeBuilder implements BicycleBuilder {
    ...
    public BicycleBuilder buildChainring() {
        bicycle.setChainring("42T Standard");
        return this;
    }
